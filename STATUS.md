...
| The release asset it installs | `0.4.0-alpha.3` — a Cartridge declares its parameters and the Slot keeps them ([#7](https://github.com/nmalex/3dsmax-sdk-mcp/issues/7)) |
