...
**Thirty slots ship today**, each with a Python and a C++ lane:

| Plugin type | Python | C++ | What it is |
| --- | --- | --- | --- |
| Geometry | [python](barebones/geometry/python/slot_geometry.py) | [native](barebones/geometry/native/src/payload.cpp) | a parametric object built as a mesh (`GEOMOBJECT_CLASS_ID`) |
...
| System | [python](barebones/system/python/slot_system.py) | [native](barebones/system/native/src/payload.cpp) | a node-system plugin (`SYSTEM_CLASS_ID`) |
| Custom attributes | [python](barebones/custom-attributes/python/slot_custattrib.py) | [native](barebones/custom-attributes/native/src/payload.cpp) | a parameter block for any object (`CUST_ATTRIB_CLASS_ID`) |
...
how each of the 30 is verified.
