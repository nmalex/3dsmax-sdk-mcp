...
# -- the panel -----------------------------------------------------------------------------------
#
# Shown in Rendering > Advanced Lighting. The slot builds it from describe_ui() and puts its own About (version, build,
...
def _panel_hello():
    mcp_bootstrap.log("display",
                      "Hello World - the Barebones Radiosity panel is live and this line came from its "
