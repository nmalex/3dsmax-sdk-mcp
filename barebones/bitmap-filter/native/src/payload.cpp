// Barebones Bitmap Filter (C++ native lane) - TEMPLATE, slot pending.
//
// An image (bitmap) filter - a filter the bitmap manager applies when sampling an image. SuperClassID BMM_FILTER_CLASS_ID. No slot ships for this type yet; this is the shape.
