// Barebones Bitmap Storage (C++ native lane) - TEMPLATE, slot pending.
//
// A bitmap storage type - how pixels are held in memory for the bitmap manager. SuperClassID BMM_STORAGE_CLASS_ID. No slot ships for this type yet; this is the shape.
