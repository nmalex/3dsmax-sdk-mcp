...
#define MAXMCP_FACADE_SURFACE_ABI 189
#define MAXMCP_FACADE_SURFACE_COUNT 5436
...
#define MAXMCP_FACADE_SURFACE(X) \
    ...
    X(ShadeSampleRead, "Shade", "result", "opaque Sample, ptr:MaxMcpShadeSample OutSample") \
    X(ShadeSampleUVW, "Shade", "result", "opaque Sample, int32 Channel, ptr:MaxMcpPoint3 OutUVW, ptr:MaxMcpPoint3 OutDUVW") \
    X(ShadeSampleAmbient, "Shade", "result", "opaque Sample, ptr:MaxMcpColor OutColor") \
    X(ShadeSampleLight, "Shade", "result", "opaque Sample, int32 Index, ptr:MaxMcpColor OutColor, ptr:MaxMcpPoint3 OutDir, ptr:float OutDotNL, ptr:float OutDiffuseCoef, ptr:int32 OutLit") \
    X(ShadeSampleIllumRead, "Shade", "result", "opaque Sample, int32 Channel, ptr:MaxMcpColor OutColor") \
    X(ShadeSampleTakeSample, "Shade", "result", "opaque Sample, float X, float Y, float Scale, ptr:MaxMcpColor OutColor, ptr:MaxMcpColor OutTransparency, ptr:int32 OutHit")
...
#define MAXMCP_FACADE_HAS_ShadeSampleRead 1
#define MAXMCP_FACADE_HAS_ShadeSampleUVW 1
#define MAXMCP_FACADE_HAS_ShadeSampleAmbient 1
#define MAXMCP_FACADE_HAS_ShadeSampleLight 1
#define MAXMCP_FACADE_HAS_ShadeSampleIllumRead 1
#define MAXMCP_FACADE_HAS_ShadeSampleTakeSample 1
...
//
// per-pixel shading in managed mode, or from Python  [trade]  (materials, texture maps, shaders, samplers)
/
/
