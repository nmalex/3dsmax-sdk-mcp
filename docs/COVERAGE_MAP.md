...
This kit authors a hello‑world barebone for **38** 3ds Max plugin types (the super‑class census, FR‑0002).
Not all 38 receive a runnable slot, and that is a **deliberate, evidence‑based** outcome, not a gap: a
...
**38 = 29 slots + 8 shelved (not third‑party registerable) + 1 deferred (registers, hello unreachable).**

---

## 29 types with a shipped slot

Each registers a real plugin under its super‑class. **Every one of the 29 reports itself on load**: the
